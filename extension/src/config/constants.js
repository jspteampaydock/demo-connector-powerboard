export default {
    ...
    CTP_INTERACTION_TYPE_GET_VAULT_TOKEN_REQUEST: 'getVaultTokenRequest',
    CTP_INTERACTION_TYPE_MAKE_PAYMENT_REQUEST: 'makePaymentRequest',
    ...
    CTP_CUSTOM_FIELD_POWERBOARD_PAYMENT_STATUS: 'PowerboardPaymentStatus',
    CTP_CUSTOM_FIELD_REFUNDED_AMOUNT: 'RefundedAmount',
    CTP_CUSTOM_FIELD_POWERBOARD_TRANSACTION_ID: 'PowerboardTransactionId',
    CTP_CUSTOM_FIELD_POWERBOARD_PAYMENT_TYPE: 'PowerboardPaymentType',
